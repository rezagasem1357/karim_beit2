    ...
    try {
      ...
      pdf.addPage(
        pw.MultiPage(
          ...
          build: (context) => [
            pw.Center(
                child: _pdfTextWidget('بارنامه شماره ${manifest.number}', font,
                    fontSize: 24,
            ...
            pw.Container(
              ...
              child: pw.Column(
                  ...
                  children: [
                    _pdfTextWidget('تاریخ: ${manifest.date}', font,
                        fontWeight: pw.FontWeight.bold),
            ...
            _pdfTextWidget('لیست کالاها', font,
            ...
            pw.Table(
              ...
              children: [
                pw.TableRow(
                    ...
                    children: [
                      _pdfCell('ردیف', font, bold: true),
                      _pdfCell('نام کالا', font, bold: true),
                      _pdfCell('تعداد', font, bold: true),
                      _pdfCell('قیمت', font, bold: true),
                    ]),
                ...manifest.items
                    .asMap()
                    .entries
                    .map((entry) => pw.TableRow(children: [
                          _pdfCell('${entry.key + 1}', font),
                          _pdfCell(entry.value.name, font,
